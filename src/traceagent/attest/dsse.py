...
from traceagent.attest.errors import (
    AttestationError,
    EnvelopeFormatError,
    KeyValidationError,
...
PREDICATE_TYPE = "https://traceagent.dev/attestations/TraceManifest/v1"
...
def _gate_source_files() -> dict[str, str]:
    ...
    gate_files = [
        source_root / "src" / "traceagent" / "gates" / "l1.py",
        source_root / "src" / "traceagent" / "gates" / "l2.py",
        source_root / "src" / "traceagent" / "codegen" / "property_gen.py",
    ]
